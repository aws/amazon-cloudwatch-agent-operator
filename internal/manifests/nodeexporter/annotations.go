...
// Annotations return the annotations for NodeExporter pod.
func Annotations(instance v1alpha1.NodeExporter) map[string]string {
	...
	annotations["amazon-cloudwatch-agent-operator-config/sha256"] = getConfigMapSHA(instance.Spec.TlsConfig)
