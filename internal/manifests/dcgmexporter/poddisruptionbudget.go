...
// PodDisruptionBudget builds a PDB for the DcgmExporter workload when
...
func PodDisruptionBudget(params manifests.Params) *policyV1.PodDisruptionBudget {
	if params.DcgmExp.Spec.PodDisruptionBudget == nil {
	...
	return &policyV1.PodDisruptionBudget{
		...
		Spec: policyV1.PodDisruptionBudgetSpec{
			MinAvailable:   params.DcgmExp.Spec.PodDisruptionBudget.MinAvailable,
			MaxUnavailable: params.DcgmExp.Spec.PodDisruptionBudget.MaxUnavailable,
