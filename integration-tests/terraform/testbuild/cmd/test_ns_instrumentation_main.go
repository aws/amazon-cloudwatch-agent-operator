...
func main() {
	...
	envMap, err := getNsPodEnvVariables(podName, namespace)
	if err != nil {
	...
	fileData, err := ioutil.ReadFile("ns_stored_env_variables.json")
	if err != nil {
...
func getNsPodEnvVariables(podName, namespace string) (map[string]string, error) {
