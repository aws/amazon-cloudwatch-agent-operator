...
<table>
    ...
    <tbody><tr>
        ...
        <td>
          Args is the set of arguments to pass to the CloudWatch Agent binary<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>config</b></td>
        <td>string</td>
        <td>
          Config is the raw JSON to be used as the collector's configuration. Refer to the CloudWatch Agent documentation for details.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>[]object</td>
        <td>
          ENV vars to set on the CloudWatch Agent's Pods. These can then in certain cases be consumed in the config file for the Collector.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>[]object</td>
        <td>
          List of sources to populate environment variables on the CloudWatch Agent's Pods. These can then in certain cases be consumed in the config file for the Collector.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>string</td>
        <td>
          Image indicates the container image to use for the CloudWatch Agent.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>object</td>
        <td>
          Ingress is used to specify how CloudWatch Agent is exposed. This functionality is only available if one of the valid modes is set. Valid modes are: deployment, daemonset and statefulset.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>mode</b></td>
        ...
        <td>map[string]string</td>
        <td>
          NodeSelector to schedule CloudWatch Agent pods. This is only relevant to daemonset, statefulset, and deployment mode<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>integer</td>
        <td>
          Replicas is the number of pod instances for the underlying CloudWatch Agent. Set this if your are not using autoscaling<br/>
          <br/>
            <i>Format</i>: int32<br/>
        </td>
        <td>false</td>
        ...
        <td>object</td>
        <td>
          Resources to set on the CloudWatch Agent pods.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>[]object</td>
        <td>
          Toleration to schedule CloudWatch Agent pods. This is only relevant to daemonset, statefulset, and deployment mode<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
Ingress is used to specify how CloudWatch Agent is exposed. This functionality is only available if one of the valid modes is set. Valid modes are: deployment, daemonset and statefulset.
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#amazoncloudwatchagentspecvolumeclaimtemplatesindexspecresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. 
 This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. 
...
### AmazonCloudWatchAgent.spec.volumeClaimTemplates[index].spec.resources.claims[index]
<sup><sup>[↩ Parent](#amazoncloudwatchagentspecvolumeclaimtemplatesindexspecresources)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        <td><b><a href="#amazoncloudwatchagentspecvolumesindexephemeralvolumeclaimtemplatespecresourcesclaimsindex">claims</a></b></td>
        <td>[]object</td>
        <td>
          Claims lists the names of resources, defined in spec.resourceClaims, that are used by this container. 
 This is an alpha field and requires enabling the DynamicResourceAllocation feature gate. 
...
### AmazonCloudWatchAgent.spec.volumes[index].ephemeral.volumeClaimTemplate.spec.resources.claims[index]
<sup><sup>[↩ Parent](#amazoncloudwatchagentspecvolumesindexephemeralvolumeclaimtemplatespecresources)</sup></sup>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>string</td>
        <td>
          Version of the managed CloudWatch Agent (operand)<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
