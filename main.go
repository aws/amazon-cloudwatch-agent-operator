...
func main() {
	...
	autoInstrumentationConfig := map[string]map[string]map[string]string{"java": {"limits": {"cpu": "64Mi", "memory": "500m"}, "requests": {"cpu": "", "memory": "50m"}}, "python": {"limits": {"cpu": "32Mi", "memory": "500m"}, "requests": {"cpu": "", "memory": "50m"}}, "dotnet": {"limits": {"cpu": "128Mi", "memory": "500m"}, "requests": {"cpu": "", "memory": "50m"}}}
