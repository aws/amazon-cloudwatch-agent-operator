...
type AmazonCloudWatchAgentSpec struct {
	...
	// +optional
	TargetAllocator v1alpha1.AmazonCloudWatchAgentTargetAllocator `json:"targetAllocator,omitempty"`
	...
	// +optional
	Prometheus v1alpha1.PrometheusConfig `json:"prometheus,omitempty"`
